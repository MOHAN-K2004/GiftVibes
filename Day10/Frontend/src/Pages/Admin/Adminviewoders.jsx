...
const Adminviewoders = () => {
  return (
    ...
    <Adminsidebar/>
    <div>
       <div class=" ml-[320px]  pl-[100px] relative flex flex-col  h-full text-gray-700 bg-white shadow-md rounded-xl bg-clip-border">
    ...
    <div class="flex items-center justify-between gap-8 mb-8">
      <div>
        ...
        <p class="block mt-1 font-sans text-base antialiased font-normal leading-relaxed text-gray-700">
          See information about gift orders
        </p>
      </div>
