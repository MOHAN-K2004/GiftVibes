...
const UserNavbar = () => {
    ...
    const gotousermyorderpage=()=>{
        navigate('/usermyorderpage');
    }
  return (
    <div class="h-20 w-full shadow-lg">
          <div class="flex justify-between">
            ...
            <a href="#" class="flex items-center -mb-6 text-2xl font-semibold text-black-900 dark:text-black">
                ...
                <p onClick={gotousermyorderpage} className='hover:text-blue-400 cursor-pointer'>My Orders</p>
            ...
            <div className='flex justify-between w-[200px]'>
                ...
                <p className='mr-[60px] mt-8'>UserMohan</p>
            </div>
          </div>
    </div>
  )
