...
const Adminthemes = () => {
  return (
    ...
    <div className='ml-[300px]'>
      ...
      <div className="p-[100px]  flex flex-wrap -z-20 items-center justify-center">
        <div className="flex-shrink-0 mt-[100px] m-6 relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-lg">
        ...
        {/* Repeat similar structure for other plant cards */}
        <div className="flex-shrink-0 mt-[100px] m-6 relative overflow-hidden bg-teal-500 rounded-lg max-w-xs shadow-lg">
        ...
        {/* Repeat similar structure for other plant cards */}
        <div className="flex-shrink-0 mt-[100px] m-6 relative overflow-hidden bg-purple-500 rounded-lg max-w-xs shadow-lg">
          <svg className="absolute bottom-0 left-0 mb-8" viewBox="0 0 375 283" fill="none" style={{ transform: 'scale(1.5)', opacity: 0.1 }}>
            <rect x="159.52" y="175" width="152" height="152" rx="8" transform="rotate(-45 159.52 175)" fill="white" />
            <rect y="107.48" width="152" height="152" rx="8" transform="rotate(-45 0 107.48)" fill="white" />
          </svg>
