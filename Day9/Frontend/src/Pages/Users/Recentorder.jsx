  ...
  return (
    ...
    <section class="py-24 relative">
        <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
            ...
            <h6 class="font-medium text-xl leading-8 text-black mb-3">Hello, Mohan</h6>
            ...
            <div
                ...
                <div class="box group">
                    ...
                    <h6 class="font-semibold font-manrope text-2xl leading-9 text-black">211,c-block,skct boys hostel,skct, kovaipudhur,Dharmapuri
                    </h6>
                </div>
            </div>
            ...
            <div class="grid grid-cols-7 w-full pb-6 border-b border-gray-100">
                <div class="col-span-7 min-[500px]:col-span-2 md:col-span-1">
                    <img src="https://st2.depositphotos.com/1219867/8235/i/450/depositphotos_82350542-stock-photo-beautiful-gold-present-box-with.jpg" alt="Skin Care Kit image" class="w-full"/>
                </div>
                <div
            ...
            <div class="grid grid-cols-7 w-full py-6 border-b border-gray-100">
                <div class="col-span-7 min-[500px]:col-span-2 md:col-span-1">
                    <img src="https://media.istockphoto.com/id/1443034333/photo/christmas-or-birthday-gift-box-on-white-wooden-table-against-blue-turquoise-bokeh-lights.webp?b=1&s=170667a&w=0&k=20&c=eYTUElhPAvtOy4iPb8Lk2qX_8kl5wfy3TIIm33dDq18=" alt="Skin Tone Serum image" class="w-full"/>
                </div>
                <div
                    class="col-span-7 min-[500px]:col-span-5 md:col-span-6 min-[500px]:pl-5 max-sm:mt-5 flex flex-col justify-center">
                    <div class="flex flex-col min-[500px]:flex-row min-[500px]:items-center justify-between">
