            ...
            <div class="lg:mb-0 mb-10">
                <div class="group w-full  h-full">
                    <div class="relative -z-40 h-full">
                        <img class="h-[700px] w-[600px]" src="https://img.etimg.com/thumb/width-640,height-480,imgsize-637126,resizemode-75,msid-99893848/top-trending-products/gifts/surprise-your-best-friend-with-6-premium-birthday-gifts-for-friends/premium-birthday-gifts-for-friends.jpg" alt="ContactUs tailwind section" class="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-700"/>
                        ...
                        <div class="absolute bottom-0 w-full lg:p-11 p-5">
                            <div class="bg-white rounded-lg p-6 block">
                                <a href="javascript:;" class="flex items-center mb-6">
                                    ...
                                    <h5 class="text-black text-base font-normal leading-6 ml-5">8524892424</h5>
                                </a>
                                <a href="javascript:;" class="flex items-center mb-6">
                                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h5 class="text-black text-base font-normal leading-6 ml-5">mohan12345@gmail.com</h5>
                                </a>
                                <a href="javascript:;" class="flex items-center">
                                    ...
                                    <h5 class="text-black text-base font-normal leading-6 ml-5">211,c-block,boys hostel,skct,kovaipudhur,coimbatore 641042.</h5>
                                </a>
                            </div>
                        </div>
                    </div>
